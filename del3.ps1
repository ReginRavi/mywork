...
$APPQuery = Get-WmiObject -Namespace Root\SMS\Site_DMZ -Class SMS_DeploymentType -Filter "LocalizedDisplayName='Reader 11.0.12'"
...
if ($smsProviderLocation = Get-WmiObject -Namespace root\sms -Class SMS_ProviderLocation -Filter 'ProviderForLocalSite=True' -ErrorAction SilentlyContinue) {
    ...
    Get-WmiObject -Namespace root -Class __NAMESPACE -Filter 'name="ccm"'